...
/* harmony export */   bigButtonExplanations: () => (/* binding */ bigButtonExplanations),
/* harmony export */   explanationtext: () => (/* binding */ explanationtext),
/* harmony export */   infotext: () => (/* binding */ infotext),
/* harmony export */   instrucciones: () => (/* binding */ instrucciones)
/* harmony export */ });
const instrucciones = {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   combkanasets: () => (/* binding */ combkanasets),
/* harmony export */   combkatakanasets: () => (/* binding */ combkatakanasets),
/* harmony export */   dakutenkanasets: () => (/* binding */ dakutenkanasets),
/* harmony export */   dakutenkatakanasets: () => (/* binding */ dakutenkatakanasets),
/* harmony export */   extrasets: () => (/* binding */ extrasets),
/* harmony export */   mainkanasets: () => (/* binding */ mainkanasets),
/* harmony export */   mainkatakanasets: () => (/* binding */ mainkatakanasets)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   kanaAnswers: () => (/* binding */ kanaAnswers),
/* harmony export */   kanaWrongs: () => (/* binding */ kanaWrongs),
/* harmony export */   romajiConsonants: () => (/* binding */ romajiConsonants)
/* harmony export */ });
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _sets_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _romaji_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
//jshint esversion:9
...
function KanaToInfo(kana) {
    if (_data_js__WEBPACK_IMPORTED_MODULE_0__.infotext[kana] === "") {
        return "...";
    }

    let symbol = "ⓘ ";
    let info = symbol.concat(_data_js__WEBPACK_IMPORTED_MODULE_0__.infotext[kana]);
...
function FindAllBaseGroup(kana) {
    ...
    if (
        _sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkanasets.hasOwnProperty(kana) ||
        _sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkatakanasets.hasOwnProperty(kana)
    ) {
        basekey = "all-base";
        return basekey;
    }
    ...
    if (
        _sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkanasets.hasOwnProperty(kana) ||
        _sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkatakanasets.hasOwnProperty(kana)
    ) {
        basekey = "all-dakuten";
        return basekey;
    }
    ...
    if (
        _sets_js__WEBPACK_IMPORTED_MODULE_1__.combkanasets.hasOwnProperty(kana) ||
        _sets_js__WEBPACK_IMPORTED_MODULE_1__.combkatakanasets.hasOwnProperty(kana)
    ) {
        basekey = "all-comb";
        return basekey;
    }
    ...
    if (
        _sets_js__WEBPACK_IMPORTED_MODULE_1__.extrasets.hasOwnProperty(kana) ||
        _sets_js__WEBPACK_IMPORTED_MODULE_1__.combkatakanasets.hasOwnProperty(kana)
    ) {
        basekey = "all-extra";
        return basekey;
...
function FindBaseGroup(kana) {
    ...
    if (_sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkanasets.hasOwnProperty(kana)) {
        basekey = "all-hiragana-base";
        return basekey;
    }

    if (_sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkanasets.hasOwnProperty(kana)) {
        basekey = "all-hiragana-dakuten";
        return basekey;
    }

    if (_sets_js__WEBPACK_IMPORTED_MODULE_1__.combkanasets.hasOwnProperty(kana)) {
        basekey = "all-hiragana-comb";
        return basekey;
    }

    if (_sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkatakanasets.hasOwnProperty(kana)) {
        basekey = "all-katakana-base";
        return basekey;
    }

    if (_sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkatakanasets.hasOwnProperty(kana)) {
        basekey = "all-katakana-dakuten";
        return basekey;
    }

    if (_sets_js__WEBPACK_IMPORTED_MODULE_1__.combkatakanasets.hasOwnProperty(kana)) {
        basekey = "all-katakana-comb";
        return basekey;
    }

    if (_sets_js__WEBPACK_IMPORTED_MODULE_1__.extrasets.hasOwnProperty(kana)) {
        basekey = "all-extra";
        return basekey;
    }
...
function BaseToObject(base) {
    switch (base) {
        ...
        case "all-hiragana-base":
            return _sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkanasets;
        case "all-hiragana-dakuten":
            return _sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkanasets;
        case "all-hiragana-comb":
            return _sets_js__WEBPACK_IMPORTED_MODULE_1__.combkanasets;
        case "all-katakana-base":
            return _sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkatakanasets;
        case "all-katakana-dakuten":
            return _sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkatakanasets;
        case "all-katakana-comb":
            return _sets_js__WEBPACK_IMPORTED_MODULE_1__.combkatakanasets;
        case "all-extra":
            return _sets_js__WEBPACK_IMPORTED_MODULE_1__.extrasets;
    }
}
...
const allmainbase = {
    ..._sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkanasets,
    ..._sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkatakanasets,
};

const alldakuten = {
    ..._sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkanasets,
    ..._sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkatakanasets,
};

const allcomb = {
    ..._sets_js__WEBPACK_IMPORTED_MODULE_1__.combkanasets,
    ..._sets_js__WEBPACK_IMPORTED_MODULE_1__.combkatakanasets,
};

const allextra = {
    ..._sets_js__WEBPACK_IMPORTED_MODULE_1__.extrasets,
};
...
function BuildHomePage() {
    ...
    instContent.textContent = _data_js__WEBPACK_IMPORTED_MODULE_0__.instrucciones.home;
    ...
    let bigButtonLearn = CreateBigButton(
        "Aprender",
        _data_js__WEBPACK_IMPORTED_MODULE_0__.bigButtonExplanations.learn
    );
    optionsContainer.appendChild(bigButtonLearn);

    let bigButtonPractice = CreateBigButton(
        "Practicar",
        _data_js__WEBPACK_IMPORTED_MODULE_0__.bigButtonExplanations.practice
    );
...
function BuildPracticeSetupPage() {
    ...
    let instContent = document.getElementById("instruccionescontent");
    instContent.textContent = _data_js__WEBPACK_IMPORTED_MODULE_0__.instrucciones.practicar;
...
function CreateSetupButtons(parentDiv) {
    ...
    Object.keys(_sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkanasets).forEach((key) => {
        let array = _sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkanasets[key];
    ...
    //botones katakana
    Object.keys(_sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkatakanasets).forEach((key) => {
        let array = _sets_js__WEBPACK_IMPORTED_MODULE_1__.mainkatakanasets[key];
        let text = JapaneseComaSeparatedArray(array);
    ...
    Object.keys(_sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkanasets).forEach((key) => {
        let array = _sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkanasets[key];
        let text = JapaneseComaSeparatedArray(array);
        CreateLabelInput(hiraganabase, key, text);
    });
    ...
    Object.keys(_sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkatakanasets).forEach((key) => {
        let array = _sets_js__WEBPACK_IMPORTED_MODULE_1__.dakutenkatakanasets[key];
        let text = JapaneseComaSeparatedArray(array);
        CreateLabelInput(katakanabase, key, text);
    });
    ...
    Object.keys(_sets_js__WEBPACK_IMPORTED_MODULE_1__.extrasets).forEach((key) => {
        let array = _sets_js__WEBPACK_IMPORTED_MODULE_1__.extrasets[key];
        let text = JapaneseComaSeparatedArray(array);
    ...
    Object.keys(_sets_js__WEBPACK_IMPORTED_MODULE_1__.combkanasets).forEach((key) => {
        let array = _sets_js__WEBPACK_IMPORTED_MODULE_1__.combkanasets[key];
        let text = JapaneseComaSeparatedArray(array);
        CreateLabelInput(hiraganabase, key, text);
    });
    ...
    btn.parentElement.classList.add("all-kata");
    //botones katakana
    Object.keys(_sets_js__WEBPACK_IMPORTED_MODULE_1__.combkatakanasets).forEach((key) => {
        let array = _sets_js__WEBPACK_IMPORTED_MODULE_1__.combkatakanasets[key];
        let text = JapaneseComaSeparatedArray(array);
        CreateLabelInput(katakanabase, key, text);
    });
}
...
function StartLearning() {
    ...
    let instContent = document.getElementById("instruccionescontent");
    instContent.textContent = _data_js__WEBPACK_IMPORTED_MODULE_0__.instrucciones.kanalearn;
...
function CheckForExplanation(cardParent) {
    ...
    let explanation = _data_js__WEBPACK_IMPORTED_MODULE_0__.explanationtext[currentSet[0]];
    ...
    if (explanation.length > 0) {
        ...
        let instContent = document.getElementById("instruccionescontent");
        instContent.textContent = _data_js__WEBPACK_IMPORTED_MODULE_0__.instrucciones.explanation;
...
function CreateLearnCard(cardParent) {
    ...
    PopulateInstructions(_data_js__WEBPACK_IMPORTED_MODULE_0__.instrucciones.kanalearn);
    ...
    learnRomaji.textContent = _romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[currentSet[0]];
...
function PreviousButton() {
    ...
    if (kanaelement != null) {
        ...
        if (indexminusone >= 0) {
            ...
            let romaji = _romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[prevkana];
            let info = document.querySelector(".info");
...
function NextButton() {
    ...
    if (kanaelement != null) {
        ...
        if (indexplusone >= currentSet.length) {
            ...
            //buscar el romaji correspondiente al nuevo kana y ponerlo tambien
            let romaji = _romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[nextkana];
            let info = document.querySelector(".info");
...
function BuildQuiz() {
    ...
    PopulateInstructions(_data_js__WEBPACK_IMPORTED_MODULE_0__.instrucciones.kanaquiz);
    ...
    let correctAnswer = _romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[currentSet[0]];
    ...
    firstWrongAnswer.textContent = _romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[randomKana];
    ...
    secondWrongAnswer.textContent = _romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[randomKana];
...
function CreateQuizButtons(currentindex, parent) {
    ...
    let answerButton = document.createElement("button");
    answerButton.classList.add("correctquizanswerbtn");
    let correctAnswer = _romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[currentSet[currentindex]];
    answerButton.textContent = correctAnswer;
    answerButton.addEventListener("click", AnswerQuiz);
    answerButtonsArray.push(answerButton);
...
function BuildLearnSetupPage() {
    ...
    PopulateInstructions(_data_js__WEBPACK_IMPORTED_MODULE_0__.instrucciones.aprender);
...
function CreateLabelInput(parent, id, text) {
    ...
    consonant.textContent = _romaji_js__WEBPACK_IMPORTED_MODULE_2__.romajiConsonants[id];
...
function BuildPracticePage(selected) {
    ...
    let instContent = document.getElementById("instruccionescontent");
    instContent.textContent = _data_js__WEBPACK_IMPORTED_MODULE_0__.instrucciones.kanatable;
...
function BuildKanaCard(kana) {
    ...
    cardDiv.setAttribute("data-answer", _romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[kana]);
    ...
    let text = `Respuesta: '${_romaji_js__WEBPACK_IMPORTED_MODULE_2__.kanaAnswers[kana]}'`;
